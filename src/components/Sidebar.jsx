...
export default function Sidebar({ mobileOpen, onClose }) {
  ...
  return (
    <aside className={`fixed inset-y-0 left-0 z-50 w-64 flex flex-col bg-navy-900 border-r border-navy-700 transition-transform duration-200 ease-in-out ${mobileOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0 md:flex-shrink-0`}>
      <div className="relative flex items-center justify-center px-4 py-3 border-b border-navy-700 flex-shrink-0">
